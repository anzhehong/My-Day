...
class CVCalendarViewAppearance: NSObject {
    ...
    var dayLabelWeekdayOutTextColor: UIColor? = .whiteColor()
...
//    var dayLabelWeekdayHighlightedBackgroundColor: UIColor? = .yellowColor()
...
//    var dayLabelPresentWeekdayHighlightedBackgroundColor: UIColor? = .yellowColor()
...
//    var dayLabelWeekdaySelectedBackgroundColor: UIColor? = UIColor.yellowColor()
...
//    当日日期背景
    var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = UIColor(red: 85/255, green: 0, blue: 8/255, alpha: 1)
//    var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0xFF5E3A)
//    var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = .yellowColor()
